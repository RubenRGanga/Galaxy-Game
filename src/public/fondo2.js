class Fondo2{ //background
    constructor(w, h, ctx){//establece los nombres de los valores para el constructor
        ...
        this.img = new Image(); 
        this.img.src = "assets/img/parallax-mountain-trees.png"
        this.x = 0 //situa la imagen en el eje X e Y
        this.y = 0
        
        this.dx = 12 //Establece los pixeles que se desplaza dando la sensación de movimiento. 
    }
